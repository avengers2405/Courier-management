...
<body>
    ...
    <div>
        <h5><a href="admin/adminlogin.php" style="float: right; margin-right:40px; color:blue; margin-top:0px">Reciever Login</a></h5>
    </div>
    <div class="container" style="border-radius:5px;border:1px solid;border-color:lightblue;border-collapse:collapse;background-color:lightblue;margin-top: 60px; width:50%;max-width:500px">
        <div class="row">
            <div class="col-md-12">
                <br>
                <h2 style="color: #273c75;"><center>Login (Counter Service)<center></h2>
                <br>
                <!-- <?php echo $error; ?> -->
                <form action="" method="post">
                    <div class="form-group">
                        <table width='90%' style="border-radius:10px;overflow:hidden;border-collapse:collapse;margin-top:30px;margin-bottom:30px;margin-left:auto;margin-right:auto;">
                            <tr>
                                <td>Email Address</td>
                                <td><input type="email" name="email" class="form-control" placeholder="Enter username/emailId" required /></td>
                            </tr>
                    <!-- </div> -->
                    <!-- <div class="form-group"> -->
                            <tr>
